...
export const metadata: Metadata = {
	...
	description:
		"Precision. Discipline. Magic. - Expert DevOps consultancy specializing in platform engineering, automation, and cloud-native infrastructure. Transform your development workflow with mystical precision.",
	keywords: [
		"DevOps",
