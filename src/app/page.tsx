...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      <section className="relative flex min-h-screen flex-col items-center justify-center px-6 text-center pt-16 overflow-hidden">
        ...
        >
          <h1 className="text-5xl leading-tight tracking-tight md:text-7xl md:leading-[1.05]">
            <span className="text-[--color-text]">Precision. Discipline.</span>{" "}
            <span className="text-[--color-brand]">Magic.</span>
          </h1>

          <p className="mt-8 text-xl text-[--color-muted] max-w-2xl mx-auto">
